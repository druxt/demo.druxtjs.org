...
/**
 * @file
 * Shared helper functions for the demo site's DevTools scripts.
 *
...
function server_pid_file(): string {
  ...
  return sprintf('/tmp/druxtjs-demo-drupal-php-server-%s.pid', hash('sha256', (string) getcwd()));
}
...
// @codeCoverageIgnoreStart
if (!function_exists('DemoDevTools\quit') && !class_exists('PHPUnit\\Framework\\TestCase')) {
